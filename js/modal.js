...
function showModal(param,ttl){
  ...
  switch(typeof param){
    ...
    case 'object':
      ...
      param.onclick = function () {//ontouchstart 
        ttl = ttl || '&nbsp;';
  ...
  function modalVisible(text,ttl){
    ...
    //find form
    var formAjaxModal = modalWindow_inner.querySelector('.formAjax');
    if(formAjaxModal)
      formAjaxModal.addEventListener('submit', ajaxForm.bind(null,formAjaxModal));
    // /find form
